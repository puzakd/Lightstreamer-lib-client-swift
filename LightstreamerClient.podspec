...
Pod::Spec.new do |s|
  ...
  s.version          = '5.0.3-custom'
  s.summary          = 'Lightstreamer Swift Client SDK'
  s.homepage         = 'https://github.com/puzakd/Lightstreamer-lib-client-swift'
  s.license          = { :type => 'Apache 2.0', :file => 'LICENSE.md' }
  s.author           = { 'Lightstreamer' => 'support@lightstreamer.com' }
  s.source           = { :git => 'https://github.com/puzakd/Lightstreamer-lib-client-swift.git', :tag => s.version.to_s }
